    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.CharField(choices=[('one_time', 'One-Time'), ('monthly', 'Monthly'), ('yearly', 'Yearly'), ('quarterly', 'Quarterly'), ('bi_weekly', 'Bi-Weekly'), ('semi_annually', 'Semi-Annually'), ('weekly', 'Weekly'), ('daily', 'Daily')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('category', models.ForeignKey(limit_choices_to={'category_type': 'Expense'}, on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='home_app.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('category', models.ForeignKey(limit_choices_to={'category_type': 'Income'}, on_delete=django.db.models.deletion.CASCADE, related_name='income', to='home_app.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField()),
                ('end_date', models.DateField()),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='overallbudget', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Report',
