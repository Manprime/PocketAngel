...
class OverallBudgetForm(forms.ModelForm):
    class Meta:
        model = OverallBudget
        fields = ['amount_limit', 'category','start_date', 'end_date']
        widgets = {
            'start_date': forms.DateInput(attrs={'placeholder': 'MM/DD/YYYY'}),
            'end_date': forms.DateInput(attrs={'placeholder': 'MM/DD/YYYY'}),
...
class GoalForm(forms.ModelForm):
    class Meta:
        model=Goal
        fields=('goal','deadline','amount_required','current_savings','description')
        widgets = {
            'deadline': forms.DateInput(attrs={'placeholder': 'MM/DD/YYYY'}),
